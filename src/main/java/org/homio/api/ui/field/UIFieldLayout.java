...
public @interface UIFieldLayout {
  ...
  class LayoutBuilder {
     ...
     * columnWidthInPercent[i] must be greater than 10%
     *
  ...
  class RowBuilder {
    ...
    public RowBuilder addCol(
        @NotNull String value, @NotNull HorizontalAlign horizontalAlign, int colSpan) {
      RowBuilder rowBuilder =
          addCol(
              column ->
                  column.setValue(value).setHorizontalAlign(horizontalAlign).setCollSpan(colSpan));
