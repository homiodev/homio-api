...
public interface UIMultiButtonItemBuilder
  ...
  @NotNull UIMultiButtonItemBuilder addButton(@NotNull String key, @Nullable String title, @Nullable Icon icon);

  default @NotNull UIMultiButtonItemBuilder addButton(@NotNull OptionModel optionModel) {
    Icon icon = optionModel.getIcon() == null ? null : new Icon(optionModel.getIcon(), optionModel.getColor());
    return addButton(optionModel.getKey(), optionModel.getTitle(), icon);
  }

  default @NotNull UIMultiButtonItemBuilder addButtons(@NotNull Collection<OptionModel> optionModels) {
  ...
  @NotNull UIMultiButtonItemBuilder setActive(@NotNull String activeButtonKey);
}
