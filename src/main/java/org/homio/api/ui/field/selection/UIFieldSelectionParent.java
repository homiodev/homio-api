...
public @interface UIFieldSelectionParent {
  ...
  /**
   * In case if we want to configure parent dynamically. If entity/bean configured by
   * anotation @UIFieldSelectionParent and implement SelectionParent interface that it's merge both.
   * interface SelectionParent overrides annotated values if values not null
   */
