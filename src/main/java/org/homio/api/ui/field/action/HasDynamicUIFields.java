...
public interface HasDynamicUIFields {
  ...
  /**
   * We maye gather all fields inside this method to find UpdatableValue to write or
   * assembleUIFields(...)
   *
  ...
  default void writeDynamicFieldValue(@NotNull String key, @Nullable Object value) {
    ...
    if (fields != null) {
      updatableValue.set(
          fields.stream().filter(f -> f.getName().equals(key)).findAny().orElse(null));
    }
    if (updatableValue.get() == null) {
      assembleUIFields(
          new UIFieldBuilder() {
            @Override
            public @NotNull FieldBuilder addColorPicker(
                int order, @NotNull UpdatableValue<String> value) {
              return fake(value);
            }

            @Override
            public @NotNull FieldBuilder addIconPicker(
                int order, @NotNull UpdatableValue<String> value) {
              return fake(value);
            }

            @Override
            public @NotNull FieldBuilder addSwitch(
                int order, @NotNull UpdatableValue<Boolean> value) {
              return fake(value);
            }

            @Override
            public @NotNull FieldBuilder addInput(
                int order, @NotNull UpdatableValue<String> value) {
              return fake(value);
            }

            @Override
            public @NotNull FieldBuilder addSlider(
                int order,
                float min,
                float max,
            ...
            @Override
            public @NotNull FieldBuilder addNumber(
                int order, @NotNull UpdatableValue<Integer> value) {
              return fake(value);
            }

            @Override
            public @NotNull FieldBuilder addSelect(
                int order,
                @NotNull UpdatableValue<String> value,
                @NotNull List<OptionModel> selections) {
              return fake(value);
            }

            @Override
            public @NotNull FieldBuilder addMultiSelect(
                int order,
                @NotNull UpdatableValue<String> value,
                @NotNull List<OptionModel> selections) {
              return fake(value);
            ...
            @Override
            public @NotNull FieldBuilder addChips(
                int order, @NotNull UpdatableValue<String> value) {
              return fake(value);
            }
            ...
            private FieldBuilder fake(UpdatableValue value) {
              ...
              return new FieldBuilder() {
                @Override
                public @NotNull FieldBuilder group(
                    @NotNull String name, int order, @Nullable String borderColor) {
                  return this;
                }
  ...
  interface UIFieldBuilder {
    ...
    @NotNull
    FieldBuilder addSelect(
        int order, @NotNull UpdatableValue<String> value, @NotNull List<OptionModel> selections);

    @NotNull
    FieldBuilder addMultiSelect(
        int order, @NotNull UpdatableValue<String> value, @NotNull List<OptionModel> selections);
