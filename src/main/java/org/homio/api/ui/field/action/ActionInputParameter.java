...
public class ActionInputParameter {
  ...
  public static @NotNull ActionInputParameter icon(String name, String defaultValue) {
  ...
  public static @NotNull ActionInputParameter textRequired(
      String name, String defaultValue, int min, int max) {
    return new ActionInputParameter(
        name, UIActionInput.Type.text, Set.of("min:" + min, "max:" + max), defaultValue);
  }

  public static @NotNull ActionInputParameter email(String name, String defaultValue) {
    return new ActionInputParameter(
        name, UIActionInput.Type.text, Collections.singleton("email"), defaultValue);
  }

  public static @NotNull ActionInputParameter password(String name, String defaultValue) {
    return new ActionInputParameter(
        name, UIActionInput.Type.password, Collections.singleton("password"), defaultValue);
  }

  public static @NotNull ActionInputParameter bool(String name, boolean defaultValue) {
    return new ActionInputParameter(
        name, UIActionInput.Type.bool, null, String.valueOf(defaultValue));
  }

  public static @NotNull ActionInputParameter message(@NotNull String message) {
  ...
  public static @NotNull ActionInputParameter ip(@NotNull String name, String defaultIpAddress) {
    return new ActionInputParameter(
        name, UIActionInput.Type.ip, Collections.singleton("ip"), defaultIpAddress);
  }

  public static @NotNull ActionInputParameter textarea(String name, String value) {
  ...
  public static @NotNull ActionInputParameter select(String name, List<OptionModel> options) {
