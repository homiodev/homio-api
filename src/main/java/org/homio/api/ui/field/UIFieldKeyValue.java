 ...
 *
 * <p>UIKeyValueField(maxSize = 5, keyType = UIFieldType.Float, valueType = UIFieldType.ColorPicker,
 * defaultKey = "0", defaultValue = "#FFFFFF") public String getThreshold() { return
 * getJsonData("threshold", "{}"); }
 */
