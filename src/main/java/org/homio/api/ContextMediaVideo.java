...
public interface ContextMediaVideo {
    ...
    Unregistered addVideoSourceListener(@NotNull String key, @NotNull RegisterVideoSourceListener listener);

    Unregistered addVideoSourceInfo(@NotNull String path, @NotNull Map<String, OptionModel> videoSources);

    Unregistered addVideoSourceInfoListener(@NotNull String name, @NotNull VideoSourceInfoListener listener);
