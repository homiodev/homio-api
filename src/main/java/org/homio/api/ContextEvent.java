...
public interface ContextEvent {
  ...
  @NotNull
  default ContextEvent addEventListener(
      @NotNull String key, @Nullable String discriminator, @NotNull Consumer<State> listener) {
   ...
   */
  @NotNull
  default ContextEvent addEventBehaviourListener(
      @NotNull String key, @NotNull Consumer<State> listener) {
   ...
   */
  @NotNull
  ContextEvent addEventBehaviourListener(
      @NotNull String key,
      @Nullable String discriminator,
      @Nullable Duration ttl,
      @NotNull Consumer<State> listener);

  default @NotNull ContextEvent addEventBehaviourListener(
      @NotNull String key, @Nullable String discriminator, @NotNull Consumer<State> listener) {
  ...
  ContextEvent addEventBehaviourListener(
      ...
      @Nullable String discriminator,
      @NotNull BiConsumer<String, State> listener);
  ...
  default ContextEvent fireDeviceStatus(@NotNull String key, @NotNull HasStatusAndMsg entity) {
    return fireEvent(
        key + "-status-" + entity.getEntityID(), new StringType(entity.getStatus().name()));
  }
  ...
  <T extends BaseEntityIdentifier> ContextEvent addEntityUpdateListener(
      ...
      @NotNull String key,
      @NotNull EntityUpdateListener<T> listener);
