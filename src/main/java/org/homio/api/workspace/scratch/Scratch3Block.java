...
public class Scratch3Block implements Comparable<Scratch3Block> {
  ...
  public @NotNull ArgumentTypeDescription addArgument(
      @NotNull String argumentName, @NotNull ArgumentType type) {
    return addArgument(argumentName, type, "");
  }

  public @NotNull ArgumentTypeDescription addArgument(
      @NotNull String argumentName, boolean defaultValue) {
  ...
  public @NotNull ArgumentTypeDescription addArgument(
      @NotNull String argumentName, @NotNull String defaultValue) {
    return addArgument(argumentName, ArgumentType.string, defaultValue);
  }

  public @NotNull ArgumentTypeDescription addArgument(
      @NotNull String argumentName, @NotNull Integer defaultValue) {
    return addArgument(argumentName, ArgumentType.number, String.valueOf(defaultValue));
  }

  public @NotNull ArgumentTypeDescription addArgument(
      @NotNull String argumentName, @NotNull Long defaultValue) {
    return addArgument(argumentName, ArgumentType.number, String.valueOf(defaultValue));
  }

  public @NotNull ArgumentTypeDescription addArgument(
      @NotNull String argumentName, @NotNull Float defaultValue) {
    return addArgument(argumentName, ArgumentType.number, String.valueOf(defaultValue));
  }

  public @NotNull ArgumentTypeDescription addArgument(
      @NotNull String argumentName, @NotNull Double defaultValue) {
    return addArgument(argumentName, ArgumentType.number, String.valueOf(defaultValue));
  }

  @SneakyThrows
  public @NotNull <T extends ScratchSettingBaseEntity> ArgumentTypeDescription addSetting(
      @NotNull Class<T> settingClass) {
  ...
  public @NotNull ArgumentTypeDescription addArgument(
      @NotNull String argumentName, @NotNull ArgumentType type, @NotNull String defaultValue) {
  ...
  public @NotNull ArgumentTypeDescription addArgument(
      @NotNull String argumentName, @NotNull MenuBlock menu) {
    ArgumentTypeDescription argumentTypeDescription =
  ...
  public static class ArgumentTypeDescription {
    ...
    ArgumentTypeDescription(
        @NotNull ArgumentType type, @Nullable String defaultValue, @Nullable MenuBlock menuBlock) {
      this.type = type;
