...
public interface ContextVar {
  ...
  default void onVariableCreated(
      @NotNull String discriminator, Consumer<Variable> variableListener) {
    onVariableCreated(discriminator, null, variableListener);
  }

  default void onVariableRemoved(
      @NotNull String discriminator, Consumer<Variable> variableListener) {
  ...
  void onVariableCreated(
      ...
      @Nullable Pattern variableIdPattern,
      Consumer<Variable> variableListener);
  ...
  default void onVariableUpdated(
      @NotNull String discriminator,
  ...
  /**
   * Every writable variable has to have exact one link listener which handle to write operation
   * from UI, etc...
   *
   * @param variableId -
   * @param listener -
   */
  void setLinkListener(
      @NotNull String variableId, @NotNull ThrowingConsumer<Object, Exception> listener);
   ...
   * @param value - value may be State type, primitive, or String/Number/Boolean/etc... ignore
   *     setting if value is null
   ...
   */
  default @Nullable Object set(@NotNull String variableId, @Nullable Object value)
      throws IllegalArgumentException {
    return set(variableId, value, true);
  }

  @Nullable
  Object set(@NotNull String variableId, @Nullable Object value, boolean fireLinkListener)
      throws IllegalArgumentException;
  ...
  @NotNull
  Variable createTransformVariable(
      @NotNull String groupId,
      @Nullable String variableId,
      @NotNull String variableName,
      @NotNull VariableType variableType,
  ...
  default @NotNull Variable createEnumVariable(
      @NotNull String groupId,
      @Nullable String variableId,
      @NotNull String variableName,
  ...
  /**
   * Ignore if variable not exists Allow remove variable if calls from 'owner' service. Also method
   * owner has to have 'org.homio.addon' endpoint Determine owner by stacktrace if owner is null
   */
  <T extends BaseDeviceEndpoint<?>> void removeVariable(
      @NotNull String variableId, @Nullable T owner);
  ...
  enum VariableType {
    ...
    Color(
        ...
        false,
        DeviceEndpoint.EndpointType.color),
    ...
    Percentage(
        o -> o instanceof Number num && num.intValue() >= 0 && num.intValue() <= 100,
        0F,
        DeviceEndpoint.EndpointType.number);
