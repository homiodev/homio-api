...
public interface ContextWidget {
  ...
  void createGaugeWidget(
    @NotNull String entityID,
    @NotNull Consumer<GaugeWidgetBuilder> widgetBuilder);
  ...
  interface GaugeWidgetBuilder extends
    WidgetBaseBuilder<GaugeWidgetBuilder>,
    ...
    @NotNull
    GaugeWidgetBuilder addSeriesGaugeValue(@Nullable String name, @NotNull Consumer<GaugeWidgetSeriesBuilder> builder);

    @NotNull
    GaugeWidgetBuilder addSeriesCustomValue(@Nullable String name, @NotNull Consumer<GaugeCustomValueWidgetSeriesBuilder> builder);

    @NotNull
    GaugeWidgetBuilder addSeriesLine(@Nullable String name, @NotNull Consumer<GaugeLineWidgetSeriesBuilder> builder);
  }
  ...
  interface GaugeCustomValueWidgetSeriesBuilder extends
    GaugeBaseWidgetSeriesBuilder<GaugeCustomValueWidgetSeriesBuilder>,
  ...
  interface GaugeWidgetSeriesBuilder extends
    GaugeBaseWidgetSeriesBuilder<GaugeWidgetSeriesBuilder>,
    HasIcon<GaugeWidgetSeriesBuilder>,
    HasValueTemplate<GaugeWidgetSeriesBuilder>,
    HasValueConverter<GaugeWidgetSeriesBuilder> {
  }

  interface GaugeLineWidgetSeriesBuilder extends
    GaugeBaseWidgetSeriesBuilder<GaugeLineWidgetSeriesBuilder> {
