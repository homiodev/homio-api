...
public class Icon {
  ...
  public static @Nullable String colorOrDefault(
      @Nullable Icon icon, @Nullable String defaultColor) {
    return defaultIfEmpty(
        Optional.ofNullable(icon).map(c -> icon.color).orElse(null), defaultColor);
  }
