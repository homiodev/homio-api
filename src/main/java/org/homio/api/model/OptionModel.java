...
public class OptionModel implements Comparable<OptionModel> {
  ...
  public static @NotNull List<OptionModel> listWithEmpty(
  ...
  public static @NotNull OptionModel of(@NotNull TreeNode item) {
    OptionModel model =
        OptionModel.of(Objects.toString(item.getId(), item.toString()), item.getName())
            .json(
                json ->
  ...
  public static <T extends Enum<T>> @NotNull List<OptionModel> enumList(
      @NotNull Class<T> enumClass, @Nullable Predicate<T> filter) {
  ...
  public static <T> @NotNull List<OptionModel> list(
  ...
  public static @NotNull List<OptionModel> entityList(
      @NotNull Collection<? extends BaseEntity> list, @NotNull Context context) {
    return entityList(list, null, context);
  }

  public static @NotNull List<OptionModel> entityList(
      @NotNull Class<? extends BaseEntity> entityClass, @NotNull Context context) {
  ...
  public static @Nullable OptionModel getByKey(
      @NotNull Collection<OptionModel> optionModels, @NotNull String key) {
