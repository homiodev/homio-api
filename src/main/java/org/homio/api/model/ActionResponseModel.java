...
public class ActionResponseModel {
  ...
  private ActionResponseModel(Object value, String param0, String value0) {
    this.value =
        value instanceof String ? Lang.getServerMessage((String) value, param0, value0) : value;
  }
  ...
  public static ActionResponseModel none() {
    return new ActionResponseModel(null);
  }
