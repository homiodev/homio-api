  ...
  public void buildWidget(WidgetRequest widgetRequest) {
    ...
    var request =
        new MainWidgetRequest(
            ...
            0,
            0,
            builder -> TemplateWidgetBuilder.buildCommon(widgetDefinition, widgetRequest, builder));
                ...
                builder.addSeries(
                    ...
                    seriesBuilder -> {
                      seriesBuilder.setChartDataSource(
                          TemplateWidgetBuilder.getSource(context, series));
