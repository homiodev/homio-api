...
public class TarEntry {
  ...
  public void extractTarHeader(String entryName) {
    header = TarHeader.createHeader(entryName, file.length, header.modTime / 1000, isDirectory);
  }
  ...
  public void writeEntryHeader(byte[] outbuf) {
    ...
    offset =
        TarHeader.getNameBytes(header.groupName, outbuf, offset, TarHeader.USTAR_GROUP_NAMELEN);
    ...
    offset =
        TarHeader.getNameBytes(header.namePrefix, outbuf, offset, TarHeader.USTAR_FILENAME_PREFIX);
