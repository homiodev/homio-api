...
public interface DataStorageService<T extends DataStorageEntity> {
  ...
  List<SourceHistoryItem> getSourceHistoryItems(
      @Nullable String field, @Nullable String value, int from, int count);
  ...
  default @NotNull List<T> findAllBy(
  ...
  @NotNull
  List<T> queryListWithSort(Bson filter, SortBy sort, Integer limit);
  ...
  default @NotNull List<T> findByPattern(
      @NotNull String field,
  ...
  default @NotNull List<Object[]> getTimeSeries(
      @Nullable Long from, @Nullable Long to, @Nullable String field, @Nullable String value) {
  ...
  default @NotNull Object aggregate(
      @Nullable Long from,
      @Nullable Long to,
      @Nullable String field,
      @Nullable String value,
  ...
  @NotNull
  DataStorageService<T> addSaveListener(
      @NotNull String discriminator, @NotNull Consumer<T> listener);
}
