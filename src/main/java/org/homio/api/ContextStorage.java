...
public interface ContextStorage {
  ...
  default @NotNull <T extends BaseEntity> T getRequire(
      @NotNull Class<T> entityClass, @NotNull String entityID) {
    T entity = CommonUtils.newInstance(entityClass);
    return getRequire(entity.setEntityID(entityID));
  }

  default @NotNull <T extends BaseEntity> T getOrCreate(
      @NotNull Class<T> entityClass, @NotNull String entityID) {
  ...
  default @Nullable <T extends BaseEntity> T getOrDefault(
      @NotNull String entityID, @Nullable T defEntity) {
    T entity = get(entityID, true);
  ...
  <T extends BaseEntity> void updateDelayed(
      @NotNull T entity, @NotNull Consumer<T> fieldUpdateConsumer);
