...
public interface EntityContextSetting {
    ...
    static void setMessage(
            @NotNull HasEntityIdentifier entity, @NotNull String distinguishKey, String message) {
        setMemValue(entity, distinguishKey + "Message", "", message);
    }
    ...
    void reloadSettings(
            @NotNull
                    Class<? extends DynamicConsoleHeaderContainerSettingPlugin>
                            dynamicSettingPluginClass,
    ...
    default <T> void listenValueAsync(
            @NotNull Class<? extends SettingPlugin<T>> settingClass,
            @NotNull String key,
    ...
    <T> void setValueRaw(
            @NotNull Class<? extends SettingPlugin<T>> bundleSettingPluginClazz,
    ...
    <T> String setValueSilence(
            @NotNull Class<? extends SettingPlugin<T>> settingClass, @NotNull T value);

    <T> void setValueSilenceRaw(
            @NotNull Class<? extends SettingPlugin<T>> settingClass, @NotNull String value);
