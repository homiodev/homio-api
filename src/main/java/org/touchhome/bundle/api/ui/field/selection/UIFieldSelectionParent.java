...
public @interface UIFieldSelectionParent {
     ...
     * anotation @UIFieldSelectionParent and implement SelectionParent interface that it's merge
     * both. interface SelectionParent overrides annotated values if values not null
     */
