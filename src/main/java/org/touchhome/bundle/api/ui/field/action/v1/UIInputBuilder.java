...
public interface UIInputBuilder extends UILayoutBuilder {
    ...
    @NotNull
    default UIButtonItemBuilder addSelectableButton(
            @NotNull String text, @NotNull UIActionHandler action) {
    ...
    @NotNull
    default DialogEntity<UIButtonItemBuilder> addOpenDialogSelectableButton(
            @NotNull String name,
            @Nullable String icon,
            @Nullable String color,
            @Nullable Integer dialogWidth,
            @NotNull UIActionHandler action) {
        return addOpenDialogSelectableButton(
                name, icon, color, dialogWidth, action, getNextOrder());
    }
    ...
    @NotNull
    default DialogEntity<UIButtonItemBuilder> addOpenDialogSelectableButton(
            @NotNull String name, @Nullable Integer dialogWidth, @NotNull UIActionHandler action) {
