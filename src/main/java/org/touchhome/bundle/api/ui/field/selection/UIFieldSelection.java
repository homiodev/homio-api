...
public @interface UIFieldSelection {
    ...
    /**
     * In case of same DynamicOptionLoader uses for few different fields, this parameter may
    ...
    /**
     * Set ui as textInout with select button if 'allowInputRawText' is true, and pure select box if
     * false
     */
