...
public interface EntityContextUI {
    ...
    default void addHeaderInfoNotification(String key, String name, String description) {
        addHeaderNotification(NotificationEntityJSON.info(key).setName(name).setValue(description));
    }

    default void addHeaderWarningNotification(String key, String name, String description) {
        addHeaderNotification(NotificationEntityJSON.warn(key).setName(name).setValue(description));
    }

    default void addHeaderErrorNotification(String key, String name, String description) {
        addHeaderNotification(NotificationEntityJSON.danger(key).setName(name).setValue(description));
    }
    ...
    default void sendJsonMessage(String title, Object json, FlowMap messageParam) {
        ...
        sendNotification(new NotificationEntityJSON(String.valueOf(System.currentTimeMillis())).setName(title)
                .setNotificationType(NotificationType.json).setValue(json));
    }
    ...
    default void sendMessage(String title, String message, NotificationType type, FlowMap messageParam, Exception ex) {
        ...
        sendNotification(new NotificationEntityJSON(String.valueOf(System.currentTimeMillis()))
                .setName(title).setNotificationType(type).setValue(text));
    }
}
