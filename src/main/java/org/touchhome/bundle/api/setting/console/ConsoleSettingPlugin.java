...
/**
 * Interface for Console settings that enable to filter settings depend on current active tab Class
 * that implement this interface must starts with 'Console'
 */
