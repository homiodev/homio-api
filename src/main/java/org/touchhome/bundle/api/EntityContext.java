...
public interface EntityContext {
    ...
    @Nullable
    default <T extends BaseEntity> T getEntityOrDefault(
    ...
    <T extends HasEntityIdentifier> void updateDelayed(
    ...
    @Nullable
    AbstractRepository<? extends BaseEntity> getRepositoryByPrefix(
